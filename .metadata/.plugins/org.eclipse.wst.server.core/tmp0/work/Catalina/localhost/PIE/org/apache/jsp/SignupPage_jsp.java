 ...
 * Generated at: 2016-01-08 23:35:57 UTC
...
return;
    ...
    try {
      ...
      out.write("    <title>Piece in everything - Sign up</title>\r\n");
      ...
      out.write("    \t\tvar regix_name = /^[a-zA-Z0-9가-힣]{2,8}$/;\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\tvar user_chk_pw = document.getElementById(\"user_password_confirm\");\r\n");
      out.write("    \t\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            if(regix_name.test(user_name.value) != true){\r\n");
      out.write("                alert(\"이름 형식이 틀렸습니다. (영문 / 한글 - 2~8글자)\");\r\n");
      out.write("                user_name.focus();\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      ...
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            if(user_chk_pw.value == \"\"){\r\n");
      out.write("                alert(\"확인 비밀번호를 입력하세요.\");\r\n");
      out.write("                user_chk_pw.focus();\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            if(regix_pw.test(user_chk_pw.value) != true){\r\n");
      out.write("            \talert(\"확인 비밀번호 형식이 틀렸습니다. (4~12글자 영문 / 숫자)\");\r\n");
      out.write("            \tuser_chk_pw.focus();\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            if(!(user_pw.value == user_chk_pw.value)){\r\n");
      out.write("                alert(\"비밀번호와 확인 비밀번호가 다릅니다.\");\r\n");
      out.write("                user_chk_pw.focus();\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            /* alert(user_email.value);\r\n");
      out.write("            alert(user_pw.value);\r\n");
      out.write("            alert(user_name.value); */\r\n");
      out.write("            \r\n");
      out.write("            $.post(\"http://210.118.74.117:8100/PIE/sign_up\", {\r\n");
      ...
      out.write("                    <input name=\"user_name\" id=\"user_name\" type=\"text\" class=\"form-control\" placeholder=\"Enter your Name\">\r\n");
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      ...
      out.write("                </div>\r\n");
      out.write("                <div class=\"form-group\">\r\n");
      out.write("                    <input name=\"user_password_confirm\" id=\"user_password_confirm\" type=\"password\" class=\"form-control\" placeholder=\"Confirm Password\">\r\n");
      out.write("                </div>\r\n");
      out.write("            <div>\r\n");
      out.write("                <button style=\"float:right;\" class=\"btn btn-default\" onclick=\"toLoginPage()\">Cancel</button>\r\n");
      out.write("                <button style=\"margin-right:10px; float:right;\" class=\"btn btn-default\" onclick=\"signUp()\">Sign up</button>\r\n");
      out.write("            </div>\r\n");
      out.write("            </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </td>\r\n");
